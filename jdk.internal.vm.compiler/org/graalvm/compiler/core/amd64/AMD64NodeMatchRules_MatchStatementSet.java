...
public class AMD64NodeMatchRules_MatchStatementSet implements MatchStatementSet {
    ...
    private static final class MatchGenerator_integerTestBranchMemory implements MatchGenerator {
        ...
        @Override
        public ComplexMatchResult match(NodeMatchRules nodeMatchRules, Object...args) {
            return ((AMD64NodeMatchRules) nodeMatchRules).integerTestBranchMemory((IfNode) args[0], (Access) args[1], (ValueNode) args[2]);
        }
        @Override
        public String getName() {
    ...
    private static final class MatchGenerator_ifCompareMemory implements MatchGenerator {
        ...
        @Override
        public ComplexMatchResult match(NodeMatchRules nodeMatchRules, Object...args) {
            return ((AMD64NodeMatchRules) nodeMatchRules).ifCompareMemory((IfNode) args[0], (CompareNode) args[1], (ValueNode) args[2], (Access) args[3]);
        }
        @Override
        public String getName() {
    ...
    private static final class MatchGenerator_addMemory implements MatchGenerator {
        ...
        @Override
        public ComplexMatchResult match(NodeMatchRules nodeMatchRules, Object...args) {
            return ((AMD64NodeMatchRules) nodeMatchRules).addMemory((ValueNode) args[0], (Access) args[1]);
        }
        @Override
        public String getName() {
             return "addMemory";
    ...
    private static final class MatchGenerator_subMemory implements MatchGenerator {
        ...
        @Override
        public ComplexMatchResult match(NodeMatchRules nodeMatchRules, Object...args) {
            return ((AMD64NodeMatchRules) nodeMatchRules).subMemory((ValueNode) args[0], (Access) args[1]);
        }
        @Override
        public String getName() {
             return "subMemory";
    ...
    private static final class MatchGenerator_mulMemory implements MatchGenerator {
        ...
        @Override
        public ComplexMatchResult match(NodeMatchRules nodeMatchRules, Object...args) {
            return ((AMD64NodeMatchRules) nodeMatchRules).mulMemory((ValueNode) args[0], (Access) args[1]);
        }
        @Override
        public String getName() {
             return "mulMemory";
    ...
    private static final class MatchGenerator_andMemory implements MatchGenerator {
        ...
        @Override
        public ComplexMatchResult match(NodeMatchRules nodeMatchRules, Object...args) {
            return ((AMD64NodeMatchRules) nodeMatchRules).andMemory((ValueNode) args[0], (Access) args[1]);
        }
        @Override
        public String getName() {
             return "andMemory";
    ...
    private static final class MatchGenerator_orMemory implements MatchGenerator {
        ...
        @Override
        public ComplexMatchResult match(NodeMatchRules nodeMatchRules, Object...args) {
            return ((AMD64NodeMatchRules) nodeMatchRules).orMemory((ValueNode) args[0], (Access) args[1]);
        }
        @Override
        public String getName() {
             return "orMemory";
    ...
    private static final class MatchGenerator_xorMemory implements MatchGenerator {
        ...
        @Override
        public ComplexMatchResult match(NodeMatchRules nodeMatchRules, Object...args) {
            return ((AMD64NodeMatchRules) nodeMatchRules).xorMemory((ValueNode) args[0], (Access) args[1]);
        }
        @Override
        public String getName() {
             return "xorMemory";
    ...
    private static final class MatchGenerator_signExtend implements MatchGenerator {
        ...
        @Override
        public ComplexMatchResult match(NodeMatchRules nodeMatchRules, Object...args) {
            return ((AMD64NodeMatchRules) nodeMatchRules).signExtend((SignExtendNode) args[0], (Access) args[1]);
        }
        @Override
        public String getName() {
             return "signExtend";
    ...
    private static final class MatchGenerator_zeroExtend implements MatchGenerator {
        ...
        @Override
        public ComplexMatchResult match(NodeMatchRules nodeMatchRules, Object...args) {
            return ((AMD64NodeMatchRules) nodeMatchRules).zeroExtend((ZeroExtendNode) args[0], (Access) args[1]);
        }
        @Override
        public String getName() {
             return "zeroExtend";
    ...
    private static final class MatchGenerator_floatConvert implements MatchGenerator {
        ...
        @Override
        public ComplexMatchResult match(NodeMatchRules nodeMatchRules, Object...args) {
            return ((AMD64NodeMatchRules) nodeMatchRules).floatConvert((FloatConvertNode) args[0], (Access) args[1]);
        }
        @Override
        public String getName() {
             return "floatConvert";
    ...
    private static final class MatchGenerator_reinterpret implements MatchGenerator {
        ...
        @Override
        public ComplexMatchResult match(NodeMatchRules nodeMatchRules, Object...args) {
            return ((AMD64NodeMatchRules) nodeMatchRules).reinterpret((ReinterpretNode) args[0], (Access) args[1]);
        }
        @Override
        public String getName() {
             return "reinterpret";
