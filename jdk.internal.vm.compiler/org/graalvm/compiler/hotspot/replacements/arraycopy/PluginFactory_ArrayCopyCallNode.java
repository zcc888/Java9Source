...
public class PluginFactory_ArrayCopyCallNode implements NodeIntrinsicPluginFactory {
    ...
    //       method: arraycopy(java.lang.Object,int,java.lang.Object,int,int,jdk.vm.ci.meta.JavaKind,org.graalvm.compiler.core.common.LocationIdentity,boolean,boolean,boolean)
    ...
    private static final class ArrayCopyCallNode_arraycopy_Object_int_Object_int_int_JavaKind_LocationIdentity_boolean_boolean_boolean extends GeneratedInvocationPlugin {
        ...
        public boolean execute(GraphBuilderContext b, ResolvedJavaMethod targetMethod, InvocationPlugin.Receiver receiver, ValueNode[] args) {
            ...
            org.graalvm.compiler.core.common.LocationIdentity arg7;
            if (args[6].isConstant()) {
                arg7 = snippetReflection.asObject(org.graalvm.compiler.core.common.LocationIdentity.class, args[6].asJavaConstant());
            } else {
                return false;
            }
            boolean arg8;
    ...
    public void registerPlugins(InvocationPlugins plugins, InjectionProvider injection) {
        plugins.register(new ArrayCopyCallNode_arraycopy_Object_int_Object_int_int_JavaKind_LocationIdentity_boolean_boolean_boolean(injection), org.graalvm.compiler.hotspot.replacements.arraycopy.ArrayCopyCallNode.class, "arraycopy", java.lang.Object.class, int.class, java.lang.Object.class, int.class, int.class, jdk.vm.ci.meta.JavaKind.class, org.graalvm.compiler.core.common.LocationIdentity.class, boolean.class, boolean.class, boolean.class);
