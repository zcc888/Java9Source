...
public class PluginFactory_MembarNode implements NodeIntrinsicPluginFactory {
    ...
    //        class: org.graalvm.compiler.nodes.extended.MembarNode
    //       method: memoryBarrier(int,org.graalvm.compiler.core.common.LocationIdentity)
    // generated-by: org.graalvm.compiler.replacements.verifier.GeneratedNodeIntrinsicPlugin$ConstructorPlugin
    ...
    public void registerPlugins(InvocationPlugins plugins, InjectionProvider injection) {
        ...
        plugins.register(new MembarNode_memoryBarrier_int_LocationIdentity(injection), org.graalvm.compiler.nodes.extended.MembarNode.class, "memoryBarrier", int.class, org.graalvm.compiler.core.common.LocationIdentity.class);
    }
}
