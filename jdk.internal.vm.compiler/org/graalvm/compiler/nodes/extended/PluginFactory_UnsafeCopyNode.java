...
public class PluginFactory_UnsafeCopyNode implements NodeIntrinsicPluginFactory {
    ...
    //       method: copy(java.lang.Object,long,java.lang.Object,long,jdk.vm.ci.meta.JavaKind,org.graalvm.compiler.core.common.LocationIdentity)
    ...
    private static final class UnsafeCopyNode_copy extends GeneratedInvocationPlugin {
        ...
        public boolean execute(GraphBuilderContext b, ResolvedJavaMethod targetMethod, InvocationPlugin.Receiver receiver, ValueNode[] args) {
            ...
            org.graalvm.compiler.core.common.LocationIdentity arg5;
            if (args[5].isConstant()) {
                arg5 = snippetReflection.asObject(org.graalvm.compiler.core.common.LocationIdentity.class, args[5].asJavaConstant());
            } else {
                return false;
            }
    ...
    public void registerPlugins(InvocationPlugins plugins, InjectionProvider injection) {
        plugins.register(new UnsafeCopyNode_copy(injection), org.graalvm.compiler.nodes.extended.UnsafeCopyNode.class, "copy", java.lang.Object.class, long.class, java.lang.Object.class, long.class, jdk.vm.ci.meta.JavaKind.class, org.graalvm.compiler.core.common.LocationIdentity.class);
    }
}
